    ...
    public void buildCastle()
    {
        ...
        foreach (Node node in nodes)
        {
            if (node.building != null)
            {
                ...
                float lowestHeight = 9999;
                float highestHeight = -9999;

                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y - (building.height / 2))) > highestHeight) highestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y - (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y - (building.height / 2))) > highestHeight) highestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y - (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y + (building.height / 2))) > highestHeight) highestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y + (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y + (building.height / 2))) > highestHeight) highestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y + (building.height / 2)));

                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y - (building.height / 2))) < lowestHeight) lowestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y - (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y - (building.height / 2))) < lowestHeight) lowestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y - (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y + (building.height / 2))) < lowestHeight) lowestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x - (building.width / 2), 0, building.y + (building.height / 2)));
                if (Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y + (building.height / 2))) < lowestHeight) lowestHeight = Terrain.activeTerrain.SampleHeight(new Vector3(building.x + (building.width / 2), 0, building.y + (building.height / 2)));

                building.size = highestHeight - lowestHeight+Random.Range(2,6);


                go.name = "building [" + building.GetHashCode() + "]";
                go.transform.localScale = new Vector3(building.width, building.size, building.height);
